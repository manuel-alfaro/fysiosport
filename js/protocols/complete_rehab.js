export const COMPLETE_REHAB_PROTOCOL = {
    id: 'complete_rehab',
    name: 'Complete Rehab',
    ...
    generateProgram(sessionData, container) {
        ...
        container.innerHTML = `
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 60px 20px; text-align: center; background: rgba(0,0,0,0.4); border-radius: 8px; margin-top: 40px;">
                ...
                <p style="font-family: 'Nimbus Sans', var(--font-main); font-size: 15px; color: rgba(255,255,255,0.5); max-width: 400px; line-height: 1.5;">The dynamic training algorithm for <strong>Complete Rehab</strong> is currently being configured.</p>
            </div>
        `;
    }
};
