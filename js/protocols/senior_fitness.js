export const SENIOR_FITNESS_PROTOCOL = {
    id: 'senior_fitness_test',
    name: 'Senior Fitness Test',
    ...
    generateProgram(sessionData, container) {
        ...
        container.innerHTML = `
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 60px 20px; text-align: center; background: rgba(0,0,0,0.4); border-radius: 8px; margin-top: 40px;">
                ...
                <p style="font-family: 'Nimbus Sans', var(--font-main); font-size: 15px; color: rgba(255,255,255,0.5); max-width: 400px; line-height: 1.5;">The dynamic training algorithm for <strong>Senior Fitness Test</strong> is currently being configured.</p>
            </div>
        `;
    }
};
